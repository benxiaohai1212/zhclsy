...
(function(){
    var WIN = window,
        ...
        SITES_PARAM = {
            SINA: {
                url : URL + '仲弘时代',
                appkey: '仲弘时代', /**您申请的应用appkey,显示分享来源(可选)*/
                title: '仲弘时代', /**分享的文字内容(可选，默认为所在页面的title)*/
				summary : '仲弘时代',/*分享摘要(可选)*/
                pic: '', /**分享图片的路径(可选)*/
        ...
        SHARE_TPL = '<a class="ntshare-sina" title="分享到新浪微博"></a><a class="ntshare-qzone" title="分享到QQ空间"></a>';
            ...
            for(var i=0;i<shareWraps.length;i++){
                ...
                bindEvent(shareWraps[i], 'click', function(e){
                    ...
                    if(clickTarget.nodeName == 'A'){
						...
						//alert(serializeParam(SITES_PARAM[clickSymbol]), 'ntshare');
